        ...
        <td>
          <div className="tools">
            ...
            <button
              ...
              onClick={() => props.deleteUser(props.id, user.username)}
            >
              <Icon.X />
            </button>
          </div>
    ...
    return (
      <div>
        ...
        <div className="form-group">
          <label htmlFor="admin">
            <input
              onChange={e => this._setState("admin", e.target.checked)}
              type="checkbox"
              id="admin"
            />
            <span>is Admin</span>
  ...
  render() {
    ...
    return (
      <div className="block">
        ...
        >
          <UserForm submitUser={this._submitUser.bind(this)} user={user} />
        </Modal>
        <table>
          <thead>
            <tr>
            ...
            users.map((u, i) => {
              ...
              return (
                <UserRow
                  ...
                  id={user.id}
                  user={user}
                  deleteUser={(id, name) => this._deleteUser(id, name)}
